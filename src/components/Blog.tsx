...
export default function Blog() {
  ...
  return (
    <section id="blog" className="relative py-28 bg-ink overflow-hidden border-b border-white/5" style={{ background: "#0a0a0a", color: "#f5f1ea" }}>
      {/* Glow Blob */}
      <div className="absolute top-1/2 left-1/4 -translate-y-1/2 h-[350px] w-[350px] rounded-full bg-[#c8ff3d]/5 blur-[120px] pointer-events-none" />
      ...
      <div className="relative mx-auto max-w-[1400px] px-5">
        ...
        <div className="mt-12 grid lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-5 lg:sticky lg:top-32">
            <div className="text-[10px] font-mono uppercase tracking-[0.22em] text-[#c8ff3d] mb-4">[ Featured Article ]</div>
            ...
            <div className="group relative rounded-[28px] bg-white/[0.02] border border-white/10 p-6 sm:p-8 hover:bg-white/[0.04] hover:border-white/15 transition-all duration-300">
              <span className="inline-flex items-center gap-2 rounded-full bg-[#c8ff3d]/10 border border-[#c8ff3d]/20 px-3 py-1 text-[10px] font-mono text-[#c8ff3d] uppercase tracking-[0.1em]">
                Patient Acquisition · 2026
              </span>
              
              <h3 className="mt-6 font-display text-3xl sm:text-4xl leading-[1.15] tracking-tight text-bone">
                How Aesthetic Clinics in India Are Getting <span className="font-serif-i text-[#c8ff3d]">3x More Patients</span> Using Digital Marketing
              </h3>
              ...
              <div className="mt-8 pt-6 border-t border-white/10 flex items-center justify-end">
                <button
                  ...
                  className="inline-flex items-center gap-2 rounded-full bg-[#c8ff3d] text-ink pl-4 pr-1.5 py-1.5 text-[12px] font-semibold hover:bg-bone transition group/btn"
                >
                  Read Full Guide
                  <span className="grid place-items-center h-7 w-7 rounded-full bg-ink text-[#c8ff3d] transition-transform group-hover/btn:translate-x-0.5">
                    →
                  </span>
                </button>
              </div>
          ...
          <div className="lg:col-span-7">
            <div className="text-[10px] font-mono uppercase tracking-[0.22em] text-[#c8ff3d] mb-4">[ The 4 Growth Channels ]</div>
              ...
              {channels.map((ch) => (
                ...
                >
                  <div className="flex items-center justify-between">
                    <span className="font-mono text-xs text-bone/30 group-hover:text-[#c8ff3d] transition duration-300">{ch.num}</span>
                  ...
                  <h4 className="mt-4 font-display text-xl font-medium text-bone group-hover:text-[#c8ff3d] transition duration-300">
                    {ch.title}
                  </h4>
                  ...
                  <div className="mt-6 flex items-center justify-between text-[11px] font-mono border-t border-white/5 pt-4">
                    ...
                    <span className="text-[#c8ff3d]">{ch.metric}</span>
                  </div>
                </div>
              ))}
            </div>
            ...
            <div className="mt-6 rounded-2xl border border-[#c8ff3d]/15 bg-[#c8ff3d]/[0.02] p-5">
              <div className="text-[10px] font-mono uppercase tracking-[0.2em] text-[#c8ff3d]">[ Digital Engine Verdict ]</div>
          ...
          <div className="h-full w-full max-w-[720px] bg-[#0c0c0c] border-l border-white/10 p-8 sm:p-12 overflow-y-auto flex flex-col justify-between shadow-[20px_0_80px_rgba(0,0,0,0.8)]">
            <div>
              ...
              <div className="flex items-center justify-between border-b border-white/10 pb-6">
                <span className="text-[10px] font-mono uppercase tracking-[0.2em] text-[#c8ff3d]">Medscale Insights</span>
                <button
              ...
              <article className="mt-8 space-y-6 text-bone/80 text-[15.5px] leading-relaxed font-sans">
                <span className="inline-block bg-[#c8ff3d]/10 px-2 py-0.5 rounded font-mono text-[10px] text-[#c8ff3d] uppercase tracking-[0.1em]">
                  Comprehensive Guide
                </span>
                
                <h2 className="font-display text-3xl sm:text-5xl leading-tight text-bone tracking-tight mt-3">
                  How Aesthetic Clinics in India Get <span className="font-serif-i text-[#c8ff3d]">3x Patients</span>
                </h2>
                ...
                <div className="border-l-2 border-[#c8ff3d] pl-4 py-1 my-6 italic text-bone/95">
            ...
            <div className="mt-8 border-t border-white/10 pt-6 flex items-center justify-between">
              ...
              <button
                ...
                className="rounded-full bg-[#c8ff3d] text-ink px-5 py-2.5 text-xs font-semibold hover:bg-bone transition"
              >
                Book Free Audit
              </button>
            </div>
