            ...
            <h2 className="font-display text-[44px] sm:text-[64px] lg:text-[88px] leading-[0.92] tracking-[-0.04em] text-ink">
              ...
              Systems that <span className="relative inline-block">
                ...
                <svg className="absolute -bottom-1 left-0 w-full" viewBox="0 0 300 14" fill="none">
                  <path d="M3 9 Q 80 -2 150 6 T 297 5" stroke="#c8ff3d" strokeWidth="4" strokeLinecap="round" />
                </svg>
              </span>.
            </h2>
            ...
            <div className="relative">
              ...
              <div className="relative rounded-[28px] bg-ink p-2 shadow-[0_30px_80px_-20px_rgba(0,0,0,.4)]" style={{ background: "#0a0a0a" }}>
                ...
                <div className="rounded-[20px] bg-[#141414] p-6 text-bone" style={{ color: "#f5f1ea" }}>
                  <div className="flex items-start justify-between">
                    <div>
                      <div className="text-[10px] font-mono uppercase tracking-[0.22em] text-[#c8ff3d]">Patient Acquisition Engine</div>
                      <div className="mt-1.5 font-display text-2xl tracking-tight">Pulse.Live<span className="text-[#c8ff3d]">.</span></div>
                    </div>
                    <div className="relative h-14 w-14">
                      <div className="spin-slow absolute inset-0 rounded-full" style={{ background: "conic-gradient(from 0deg, #c8ff3d, #ff5d3b, #c8ff3d)" }} />
                      <div className="absolute inset-[3px] rounded-full bg-[#141414] grid place-items-center text-[#c8ff3d]">✦</div>
                    </div>
                  </div>
                        ...
                        >
                          <div className="flex items-center justify-between text-[12px]">
                            <div className="flex items-center gap-2">
                              <span className="h-1.5 w-1.5 rounded-full bg-[#c8ff3d] group-hover:animate-pulse" />
                              <span className="font-medium text-bone/80 group-hover:text-bone transition-colors duration-300">{b.label}</span>
                            </div>
                            <div className="flex items-center gap-2">
                              <span className="rounded bg-[#c8ff3d]/10 border border-[#c8ff3d]/20 px-2.5 py-0.5 font-mono text-[9px] text-[#c8ff3d] font-semibold tracking-wider">
                                {b.status}
                              </span>
                            </div>
                          </div>
                              ...
                              return (
                                <div
                                  ...
                                  className={`h-full flex-1 rounded-[1.5px] transition-all duration-500 ease-out ${
                                    isActive && animate
                                      ? "bg-[#c8ff3d] shadow-[0_0_6px_rgba(200,255,61,0.4)] group-hover:shadow-[0_0_10px_rgba(200,255,61,0.85)] group-hover:bg-[#d4ff5e]"
                                      : "bg-white/5"
                                  }`}
                                  style={{
                  ...
                  <div className="mt-8 rounded-2xl bg-white/[0.03] border border-white/10 p-4">
                    <div className="flex items-center justify-between text-[11px] font-mono opacity-70">
                      <span>LEADS · 30D</span>
                      <span className="text-[#c8ff3d]">▲ +428%</span>
                    </div>
                    <div className="mt-4 flex items-end gap-1.5 h-20">
                      {Array.from({ length: 24 }).map((_, i) => {
                        ...
                        return (
                          <div
                            key={i}
                            className="flex-1 rounded-sm bg-[#c8ff3d]/80 ticker-bar"
                  ...
                  <div className="mt-5 grid grid-cols-3 gap-2.5">
                    {[
                      ...
                      <div key={m.k} className="rounded-xl border border-white/10 p-3 text-center">
                        <div className="font-display text-xl text-[#c8ff3d]">{m.v}</div>
  ...
  return (
    <div
      className={`${span} lift relative rounded-2xl p-5 border ${
        isDark ? "bg-ink text-bone border-ink" : isLime ? "bg-[#c8ff3d] text-ink border-[#c8ff3d]" : "bg-bone text-ink border-ink/10"
      }`}
