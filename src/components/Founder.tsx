      ...
      <div className="rounded-[32px] border border-ink/10 bg-[#ebe5da]/20 overflow-hidden shadow-sm relative flex flex-col md:flex-row" style={{ background: "rgba(235,229,218,.35)" }}>
        ...
        <div className="flex-1 p-8 flex flex-col justify-between gap-6">
          <div>
            ...
            <p className="mt-3 text-[14px] font-medium leading-relaxed text-ink/80 max-w-2xl font-display">
              Founder <a href="#top" className="text-[#ff5d3b] hover:text-[#ff5d3b]/80 transition duration-300 font-bold underline-draw">@medscalesystems</a> – The no 1 growth partner for healthcare | Healthcare Performance Marketing & Lead Acquisition
            </p>
