      ...
      <div className="mx-auto max-w-[1400px] px-5">
        ...
        <div className="border-y border-white/10 py-10 sm:py-16">
          <div className="font-display text-[20vw] sm:text-[18vw] lg:text-[15vw] leading-[0.85] tracking-[-0.05em]">
            Medscale<span className="text-[#c8ff3d]">®</span>
          </div>
        </div>
        ...
        <div className="mt-14 grid md:grid-cols-12 gap-10">
          <div className="md:col-span-5">
            ...
            <div className="mt-6 flex items-center gap-2">
              {[
                ...
                <a key={s.l} href="#" className="grid place-items-center h-10 w-10 rounded-full border border-white/15 hover:bg-[#c8ff3d] hover:text-ink hover:border-[#c8ff3d] transition text-[11px] font-medium">
                  {s.s}
                </a>
              ))}
            </div>
          ...
          <div className="md:col-span-3">
            ...
            <form onSubmit={(e) => e.preventDefault()} className="mt-4 flex items-center rounded-full border border-white/15 p-1">
              ...
              />
              <button className="rounded-full bg-[#c8ff3d] text-ink px-4 py-2 text-[12px] font-semibold hover:bg-white transition">
                Subscribe
              </button>
            </form>
          </div>
        ...
        <div className="mt-16 pt-10 border-t border-white/10 grid sm:grid-cols-3 gap-6">
          <div className="rounded-2xl border border-white/5 bg-white/[0.02] p-5 hover:border-white/10 hover:bg-white/[0.04] transition duration-300">
            <div className="text-[10px] font-mono uppercase tracking-[0.22em] text-[#c8ff3d]">[ Head Office ]</div>
          ...
          <div className="rounded-2xl border border-white/5 bg-white/[0.02] p-5 hover:border-white/10 hover:bg-white/[0.04] transition duration-300">
            <div className="text-[10px] font-mono uppercase tracking-[0.22em] text-[#c8ff3d]">[ Working Hours ]</div>
            <p className="mt-3 text-[13.5px] leading-relaxed opacity-70">
              Monday – Friday<br />
              07:00 AM – 09:00 PM
            </p>
          ...
          <div className="rounded-2xl border border-white/5 bg-white/[0.02] p-5 hover:border-white/10 hover:bg-white/[0.04] transition duration-300">
            <div className="text-[10px] font-mono uppercase tracking-[0.22em] text-[#c8ff3d]">[ Call Us ]</div>
            <div className="mt-3">
              <a href="tel:+918667031931" className="text-xl font-display font-medium text-bone hover:text-[#c8ff3d] transition">
                +91 86670 31931
              </a>
        ...
        <div className="mt-16 pt-6 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-3 text-[11px] font-mono uppercase tracking-[0.2em] opacity-50">
          ...
          <div className="flex items-center gap-5">
            <a href="#" className="hover:text-[#c8ff3d]">Privacy</a>
            <a href="#" className="hover:text-[#c8ff3d]">Terms</a>
            <a href="#" className="hover:text-[#c8ff3d]">HIPAA</a>
            <a href="#top" className="hover:text-[#c8ff3d]">Back to top ↑</a>
          </div>
        </div>
      </div>
    </footer>
